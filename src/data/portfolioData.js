...
export const skillGroups = [
  ...
  },
  {
    title: "Frontend & Web",
    skills: [
      { name: "React 18/19", level: 85 },
      { name: "Tailwind CSS", level: 80 },
      { name: "Vite", level: 80 },
      { name: "Vanilla JS / PWA", level: 85 },
    ],
  },
  {
    title: "AI & Quantum",
    skills: [
      ...
      { name: "Qdrant (Vector DB)", level: 75 },
      { name: "LLMs (Claude/Gemini)", level: 85 },
      { name: "Qiskit Aer", level: 70 },
    ],
  },
  {
    title: "Infra & Tools",
